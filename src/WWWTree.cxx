...
const int &run() { return mytree.run(); }
const int &lumi() { return mytree.lumi(); }
const unsigned long long &evt() { return mytree.evt(); }
const int &isData() { return mytree.isData(); }
const bool &evt_passgoodrunlist() { return mytree.evt_passgoodrunlist(); }
const float &evt_scale1fb() { return mytree.evt_scale1fb(); }
const float &evt_xsec() { return mytree.evt_xsec(); }
const float &evt_kfactor() { return mytree.evt_kfactor(); }
const float &evt_filter() { return mytree.evt_filter(); }
const int &evt_nEvts() { return mytree.evt_nEvts(); }
const vector<TString> &evt_dataset() { return mytree.evt_dataset(); }
const float &puWeight() { return mytree.puWeight(); }
const int &nVert() { return mytree.nVert(); }
const int &nTrueInt() { return mytree.nTrueInt(); }
const float &rho() { return mytree.rho(); }
const float &rho25() { return mytree.rho25(); }
const float &gen_ht() { return mytree.gen_ht(); }
const int &nBJetTight() { return mytree.nBJetTight(); }
const int &nBJetMedium() { return mytree.nBJetMedium(); }
const int &nBJetLoose() { return mytree.nBJetLoose(); }
const int &nBJetTight_up() { return mytree.nBJetTight_up(); }
const int &nBJetMedium_up() { return mytree.nBJetMedium_up(); }
const int &nBJetLoose_up() { return mytree.nBJetLoose_up(); }
const int &nBJetTight_dn() { return mytree.nBJetTight_dn(); }
const int &nBJetMedium_dn() { return mytree.nBJetMedium_dn(); }
const int &nBJetLoose_dn() { return mytree.nBJetLoose_dn(); }
const int &nJet200MuFrac50DphiMet() { return mytree.nJet200MuFrac50DphiMet(); }
const int &nMuons10() { return mytree.nMuons10(); }
const int &nBadMuons20() { return mytree.nBadMuons20(); }
const int &nElectrons10() { return mytree.nElectrons10(); }
const int &nGammas20() { return mytree.nGammas20(); }
const int &nTaus20() { return mytree.nTaus20(); }
const float &met_pt() { return mytree.met_pt(); }
const float &met_phi() { return mytree.met_phi(); }
const float &met_calo_pt() { return mytree.met_calo_pt(); }
const float &met_calo_phi() { return mytree.met_calo_phi(); }
const float &met_miniaod_pt() { return mytree.met_miniaod_pt(); }
const float &met_miniaod_phi() { return mytree.met_miniaod_phi(); }
const float &met_muegclean_pt() { return mytree.met_muegclean_pt(); }
const float &met_muegclean_phi() { return mytree.met_muegclean_phi(); }
const float &met_rawPt() { return mytree.met_rawPt(); }
const float &met_rawPhi() { return mytree.met_rawPhi(); }
const float &met_genPt() { return mytree.met_genPt(); }
const float &met_genPhi() { return mytree.met_genPhi(); }
const float &sumet_raw() { return mytree.sumet_raw(); }
const int &Flag_ecalLaserCorrFilter() { return mytree.Flag_ecalLaserCorrFilter(); }
const int &Flag_hcalLaserEventFilter() { return mytree.Flag_hcalLaserEventFilter(); }
const int &Flag_trackingFailureFilter() { return mytree.Flag_trackingFailureFilter(); }
const int &Flag_CSCTightHaloFilter() { return mytree.Flag_CSCTightHaloFilter(); }
const int &Flag_HBHENoiseFilter() { return mytree.Flag_HBHENoiseFilter(); }
const int &Flag_HBHEIsoNoiseFilter() { return mytree.Flag_HBHEIsoNoiseFilter(); }
const int &Flag_CSCTightHalo2015Filter() { return mytree.Flag_CSCTightHalo2015Filter(); }
const int &Flag_EcalDeadCellTriggerPrimitiveFilter() { return mytree.Flag_EcalDeadCellTriggerPrimitiveFilter(); }
const int &Flag_goodVertices() { return mytree.Flag_goodVertices(); }
const int &Flag_eeBadScFilter() { return mytree.Flag_eeBadScFilter(); }
const int &Flag_globalTightHalo2016() { return mytree.Flag_globalTightHalo2016(); }
const int &Flag_badMuonFilter() { return mytree.Flag_badMuonFilter(); }
const int &Flag_badChargedCandidateFilter() { return mytree.Flag_badChargedCandidateFilter(); }
const int &Flag_badMuonFilterv2() { return mytree.Flag_badMuonFilterv2(); }
const int &Flag_badChargedCandidateFilterv2() { return mytree.Flag_badChargedCandidateFilterv2(); }
const int &Flag_badMuons() { return mytree.Flag_badMuons(); }
const int &Flag_duplicateMuons() { return mytree.Flag_duplicateMuons(); }
const int &Flag_noBadMuons() { return mytree.Flag_noBadMuons(); }
const int &HLT_singleEl() { return mytree.HLT_singleEl(); }
const int &HLT_singleMu() { return mytree.HLT_singleMu(); }
const int &HLT_singleMu_noiso() { return mytree.HLT_singleMu_noiso(); }
const int &HLT_DoubleEl_noiso() { return mytree.HLT_DoubleEl_noiso(); }
const int &HLT_DoubleEl() { return mytree.HLT_DoubleEl(); }
const int &HLT_DoubleEl_DZ() { return mytree.HLT_DoubleEl_DZ(); }
const int &HLT_DoubleEl_DZ_2() { return mytree.HLT_DoubleEl_DZ_2(); }
const int &HLT_MuEG() { return mytree.HLT_MuEG(); }
const int &HLT_MuEG_2() { return mytree.HLT_MuEG_2(); }
const int &HLT_MuEG_noiso() { return mytree.HLT_MuEG_noiso(); }
const int &HLT_MuEG_noiso_2() { return mytree.HLT_MuEG_noiso_2(); }
const int &HLT_Mu8_EG17() { return mytree.HLT_Mu8_EG17(); }
const int &HLT_Mu8_EG23() { return mytree.HLT_Mu8_EG23(); }
const int &HLT_Mu8_EG23_DZ() { return mytree.HLT_Mu8_EG23_DZ(); }
const int &HLT_Mu12_EG23_DZ() { return mytree.HLT_Mu12_EG23_DZ(); }
const int &HLT_Mu17_EG12() { return mytree.HLT_Mu17_EG12(); }
const int &HLT_Mu23_EG8() { return mytree.HLT_Mu23_EG8(); }
const int &HLT_Mu23_EG8_DZ() { return mytree.HLT_Mu23_EG8_DZ(); }
const int &HLT_Mu23_EG12() { return mytree.HLT_Mu23_EG12(); }
const int &HLT_Mu23_EG12_DZ() { return mytree.HLT_Mu23_EG12_DZ(); }
const int &HLT_DoubleMu_noiso() { return mytree.HLT_DoubleMu_noiso(); }
const int &HLT_DoubleMu_noiso_27_8() { return mytree.HLT_DoubleMu_noiso_27_8(); }
const int &HLT_DoubleMu_noiso_30_11() { return mytree.HLT_DoubleMu_noiso_30_11(); }
const int &HLT_DoubleMu_noiso_40_11() { return mytree.HLT_DoubleMu_noiso_40_11(); }
const int &HLT_DoubleMu() { return mytree.HLT_DoubleMu(); }
const int &HLT_DoubleMu_tk() { return mytree.HLT_DoubleMu_tk(); }
const int &HLT_DoubleMu_dbltk() { return mytree.HLT_DoubleMu_dbltk(); }
const int &HLT_DoubleMu_nonDZ() { return mytree.HLT_DoubleMu_nonDZ(); }
const int &HLT_DoubleMu_tk_nonDZ() { return mytree.HLT_DoubleMu_tk_nonDZ(); }
const int &HLT_Photon22_R9Id90_HE10_IsoM() { return mytree.HLT_Photon22_R9Id90_HE10_IsoM(); }
const int &HLT_Photon30_R9Id90_HE10_IsoM() { return mytree.HLT_Photon30_R9Id90_HE10_IsoM(); }
const int &HLT_Photon36_R9Id90_HE10_IsoM() { return mytree.HLT_Photon36_R9Id90_HE10_IsoM(); }
const int &HLT_Photon50_R9Id90_HE10_IsoM() { return mytree.HLT_Photon50_R9Id90_HE10_IsoM(); }
const int &HLT_Photon75_R9Id90_HE10_IsoM() { return mytree.HLT_Photon75_R9Id90_HE10_IsoM(); }
const int &HLT_Photon90_R9Id90_HE10_IsoM() { return mytree.HLT_Photon90_R9Id90_HE10_IsoM(); }
const int &HLT_Photon120_R9Id90_HE10_IsoM() { return mytree.HLT_Photon120_R9Id90_HE10_IsoM(); }
const int &HLT_Photon165_R9Id90_HE10_IsoM() { return mytree.HLT_Photon165_R9Id90_HE10_IsoM(); }
const int &HLT_Photon165_HE10() { return mytree.HLT_Photon165_HE10(); }
const int &HLT_CaloJet500_NoJetID() { return mytree.HLT_CaloJet500_NoJetID(); }
const int &HLT_ECALHT800_NoJetID() { return mytree.HLT_ECALHT800_NoJetID(); }
const bool &HLT_Photon22_R9Id90_HE10_IsoM_matchedtophoton() { return mytree.HLT_Photon22_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon30_R9Id90_HE10_IsoM_matchedtophoton() { return mytree.HLT_Photon30_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon36_R9Id90_HE10_IsoM_matchedtophoton() { return mytree.HLT_Photon36_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon50_R9Id90_HE10_IsoM_matchedtophoton() { return mytree.HLT_Photon50_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon75_R9Id90_HE10_IsoM_matchedtophoton() { return mytree.HLT_Photon75_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon90_R9Id90_HE10_IsoM_matchedtophoton() { return mytree.HLT_Photon90_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon120_R9Id90_HE10_IsoM_matchedtophoton() { return mytree.HLT_Photon120_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon165_R9Id90_HE10_IsoM_matchedtophoton() { return mytree.HLT_Photon165_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon165_HE10_matchedtophoton() { return mytree.HLT_Photon165_HE10_matchedtophoton(); }
const float &dilmass() { return mytree.dilmass(); }
const float &dilpt() { return mytree.dilpt(); }
const float &dRll() { return mytree.dRll(); }
const float &matched_neutralemf() { return mytree.matched_neutralemf(); }
const float &matched_emf() { return mytree.matched_emf(); }
...
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &lep_closest_jet_p4() { return mytree.lep_closest_jet_p4(); }
const vector<double> &lep_ptRatio() { return mytree.lep_ptRatio(); }
const vector<int> &lep_motherIdSS() { return mytree.lep_motherIdSS(); }
const vector<int> &lep_genPart_index() { return mytree.lep_genPart_index(); }
const vector<double> &lep_coneCorrPt() { return mytree.lep_coneCorrPt(); }
const vector<double> &lep_ptRel() { return mytree.lep_ptRel(); }
const vector<double> &lep_relIso03() { return mytree.lep_relIso03(); }
const vector<double> &lep_relIso03DB() { return mytree.lep_relIso03DB(); }
const vector<double> &lep_relIso03EA() { return mytree.lep_relIso03EA(); }
const vector<double> &lep_relIso03EAv2() { return mytree.lep_relIso03EAv2(); }
const vector<double> &lep_relIso04DB() { return mytree.lep_relIso04DB(); }
const vector<double> &lep_relIso04EA() { return mytree.lep_relIso04EA(); }
const vector<double> &lep_relIso04EAv2() { return mytree.lep_relIso04EAv2(); }
...
const vector<float> &lep_etaSC() { return mytree.lep_etaSC(); }
const vector<float> &lep_dz() { return mytree.lep_dz(); }
const vector<int> &lep_tightId() { return mytree.lep_tightId(); }
const vector<int> &lep_mcMatchId() { return mytree.lep_mcMatchId(); }
const vector<int> &lep_lostHits() { return mytree.lep_lostHits(); }
const vector<int> &lep_convVeto() { return mytree.lep_convVeto(); }
const vector<int> &lep_tightCharge() { return mytree.lep_tightCharge(); }
const vector<float> &lep_MVA() { return mytree.lep_MVA(); }
const vector<float> &lep_validfraction() { return mytree.lep_validfraction(); }
const vector<float> &lep_pterr() { return mytree.lep_pterr(); }
const vector<float> &lep_sta_pterrOpt() { return mytree.lep_sta_pterrOpt(); }
const vector<float> &lep_glb_pterrOpt() { return mytree.lep_glb_pterrOpt(); }
const vector<float> &lep_x2ondof() { return mytree.lep_x2ondof(); }
const vector<float> &lep_sta_x2ondof() { return mytree.lep_sta_x2ondof(); }
...
const int &nisoTrack_mt2_cleaned_VVV_cutbased_veto() { return mytree.nisoTrack_mt2_cleaned_VVV_cutbased_veto(); }
const int &nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso() { return mytree.nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso(); }
const int &nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_noip() { return mytree.nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_noip(); }
const int &nisoTrack_mt2_cleaned_VVV_cutbased_fo() { return mytree.nisoTrack_mt2_cleaned_VVV_cutbased_fo(); }
const int &nisoTrack_mt2_cleaned_VVV_cutbased_fo_noiso() { return mytree.nisoTrack_mt2_cleaned_VVV_cutbased_fo_noiso(); }
const int &nisoTrack_mt2_cleaned_VVV_cutbased_tight_noiso() { return mytree.nisoTrack_mt2_cleaned_VVV_cutbased_tight_noiso(); }
const int &nisoTrack_mt2_cleaned_VVV_cutbased_tight() { return mytree.nisoTrack_mt2_cleaned_VVV_cutbased_tight(); }
const int &nisoTrack_mt2_cleaned_VVV_MVAbased_tight_noiso() { return mytree.nisoTrack_mt2_cleaned_VVV_MVAbased_tight_noiso(); }
const int &nisoTrack_mt2_cleaned_VVV_MVAbased_tight() { return mytree.nisoTrack_mt2_cleaned_VVV_MVAbased_tight(); }
const int &nisoTrack_mt2_cleaned_VVV_baseline() { return mytree.nisoTrack_mt2_cleaned_VVV_baseline(); }
...
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &gamma_p4() { return mytree.gamma_p4(); }
const vector<float> &gamma_pt() { return mytree.gamma_pt(); }
const vector<float> &gamma_eta() { return mytree.gamma_eta(); }
const vector<float> &gamma_phi() { return mytree.gamma_phi(); }
const vector<float> &gamma_mass() { return mytree.gamma_mass(); }
const vector<int> &gamma_mcMatchId() { return mytree.gamma_mcMatchId(); }
const vector<float> &gamma_genPt() { return mytree.gamma_genPt(); }
const vector<float> &gamma_genIso() { return mytree.gamma_genIso(); }
const vector<float> &gamma_chHadIso() { return mytree.gamma_chHadIso(); }
const vector<float> &gamma_neuHadIso() { return mytree.gamma_neuHadIso(); }
const vector<float> &gamma_phIso() { return mytree.gamma_phIso(); }
const vector<float> &gamma_sigmaIetaIeta() { return mytree.gamma_sigmaIetaIeta(); }
const vector<float> &gamma_r9() { return mytree.gamma_r9(); }
const vector<float> &gamma_hOverE() { return mytree.gamma_hOverE(); }
const vector<float> &gamma_hOverE_online() { return mytree.gamma_hOverE_online(); }
const vector<int> &gamma_idCutBased() { return mytree.gamma_idCutBased(); }
const vector<float> &gamma_ecpfclusiso() { return mytree.gamma_ecpfclusiso(); }
const vector<float> &gamma_hcpfclusiso() { return mytree.gamma_hcpfclusiso(); }
const vector<float> &gamma_hollowtkiso03() { return mytree.gamma_hollowtkiso03(); }
const vector<int> &gamma_genIsPromptFinalState() { return mytree.gamma_genIsPromptFinalState(); }
const vector<float> &gamma_drMinParton() { return mytree.gamma_drMinParton(); }
const int &ngenPart() { return mytree.ngenPart(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genPart_p4() { return mytree.genPart_p4(); }
const vector<float> &genPart_pt() { return mytree.genPart_pt(); }
const vector<float> &genPart_eta() { return mytree.genPart_eta(); }
const vector<float> &genPart_phi() { return mytree.genPart_phi(); }
const vector<float> &genPart_mass() { return mytree.genPart_mass(); }
const vector<int> &genPart_pdgId() { return mytree.genPart_pdgId(); }
const vector<int> &genPart_status() { return mytree.genPart_status(); }
const vector<float> &genPart_charge() { return mytree.genPart_charge(); }
const vector<int> &genPart_motherId() { return mytree.genPart_motherId(); }
const vector<int> &genPart_grandmaId() { return mytree.genPart_grandmaId(); }
const vector<bool> &genPart_isp6status3() { return mytree.genPart_isp6status3(); }
const int &ngenLep() { return mytree.ngenLep(); }
const vector<float> &genLep_pt() { return mytree.genLep_pt(); }
const vector<float> &genLep_eta() { return mytree.genLep_eta(); }
const vector<float> &genLep_phi() { return mytree.genLep_phi(); }
const vector<float> &genLep_mass() { return mytree.genLep_mass(); }
const vector<int> &genLep_pdgId() { return mytree.genLep_pdgId(); }
const vector<int> &genLep_status() { return mytree.genLep_status(); }
const vector<float> &genLep_charge() { return mytree.genLep_charge(); }
const vector<int> &genLep_sourceId() { return mytree.genLep_sourceId(); }
const vector<bool> &genLep_isp6status3() { return mytree.genLep_isp6status3(); }
const int &ngenTau() { return mytree.ngenTau(); }
const vector<float> &genTau_pt() { return mytree.genTau_pt(); }
const vector<float> &genTau_eta() { return mytree.genTau_eta(); }
const vector<float> &genTau_phi() { return mytree.genTau_phi(); }
const vector<float> &genTau_mass() { return mytree.genTau_mass(); }
const vector<int> &genTau_pdgId() { return mytree.genTau_pdgId(); }
const vector<int> &genTau_status() { return mytree.genTau_status(); }
const vector<float> &genTau_charge() { return mytree.genTau_charge(); }
const vector<int> &genTau_sourceId() { return mytree.genTau_sourceId(); }
const int &ngenLepFromTau() { return mytree.ngenLepFromTau(); }
const vector<float> &genLepFromTau_pt() { return mytree.genLepFromTau_pt(); }
const vector<float> &genLepFromTau_eta() { return mytree.genLepFromTau_eta(); }
const vector<float> &genLepFromTau_phi() { return mytree.genLepFromTau_phi(); }
const vector<float> &genLepFromTau_mass() { return mytree.genLepFromTau_mass(); }
const vector<int> &genLepFromTau_pdgId() { return mytree.genLepFromTau_pdgId(); }
const vector<int> &genLepFromTau_status() { return mytree.genLepFromTau_status(); }
const vector<float> &genLepFromTau_charge() { return mytree.genLepFromTau_charge(); }
const vector<int> &genLepFromTau_sourceId() { return mytree.genLepFromTau_sourceId(); }
const int &njets() { return mytree.njets(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jets_p4() { return mytree.jets_p4(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &removed_jets_p4() { return mytree.removed_jets_p4(); }
const vector<float> &removed_jets_csv() { return mytree.removed_jets_csv(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jets_medb_p4() { return mytree.jets_medb_p4(); }
const int &njets_up() { return mytree.njets_up(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jets_up_p4() { return mytree.jets_up_p4(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jets_medb_up_p4() { return mytree.jets_medb_up_p4(); }
const vector<float> &jets_csv() { return mytree.jets_csv(); }
const vector<float> &jets_up_csv() { return mytree.jets_up_csv(); }
const int &njets_dn() { return mytree.njets_dn(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jets_dn_p4() { return mytree.jets_dn_p4(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jets_medb_dn_p4() { return mytree.jets_medb_dn_p4(); }
const vector<float> &jets_dn_csv() { return mytree.jets_dn_csv(); }
const vector<float> &jets_muf() { return mytree.jets_muf(); }
const vector<int> &jets_mcFlavour() { return mytree.jets_mcFlavour(); }
const vector<int> &jets_mcHadronFlav() { return mytree.jets_mcHadronFlav(); }
const int &nhighPtPFcands() { return mytree.nhighPtPFcands(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &highPtPFcands_p4() { return mytree.highPtPFcands_p4(); }
const vector<float> &highPtPFcands_dz() { return mytree.highPtPFcands_dz(); }
const vector<int> &highPtPFcands_pdgId() { return mytree.highPtPFcands_pdgId(); }
const float &ht() { return mytree.ht(); }
const float &ht_up() { return mytree.ht_up(); }
const float &ht_dn() { return mytree.ht_dn(); }
const float &metsig_unofficial() { return mytree.metsig_unofficial(); }
const float &metsig_unofficial_up() { return mytree.metsig_unofficial_up(); }
const float &metsig_unofficial_dn() { return mytree.metsig_unofficial_dn(); }
const float &mt_lep1() { return mytree.mt_lep1(); }
const float &mt2() { return mytree.mt2(); }
const float &mt2_up() { return mytree.mt2_up(); }
const float &mt2_dn() { return mytree.mt2_dn(); }
const float &mt2j() { return mytree.mt2j(); }
const float &mt2b() { return mytree.mt2b(); }
const float &mt2b_up() { return mytree.mt2b_up(); }
const float &mt2b_dn() { return mytree.mt2b_dn(); }
const float &mt2_genmet() { return mytree.mt2_genmet(); }
const float &mt2b_genmet() { return mytree.mt2b_genmet(); }
const float &mjj_mindphi() { return mytree.mjj_mindphi(); }
const float &mjj() { return mytree.mjj(); }
const float &mbb_csv() { return mytree.mbb_csv(); }
const float &mbb_bpt() { return mytree.mbb_bpt(); }
const float &dphi_jj() { return mytree.dphi_jj(); }
const float &dphi_ll() { return mytree.dphi_ll(); }
const float &sum_mlb() { return mytree.sum_mlb(); }
const float &deta_jj() { return mytree.deta_jj(); }
const float &dR_jj() { return mytree.dR_jj(); }
const float &dphi_metj1() { return mytree.dphi_metj1(); }
const float &dphi_metj2() { return mytree.dphi_metj2(); }
const float &dphi_genmetj1() { return mytree.dphi_genmetj1(); }
const float &dphi_genmetj2() { return mytree.dphi_genmetj2(); }
const float &mjj_mindphi_up() { return mytree.mjj_mindphi_up(); }
const float &mjj_up() { return mytree.mjj_up(); }
const float &mbb_csv_up() { return mytree.mbb_csv_up(); }
const float &mbb_bpt_up() { return mytree.mbb_bpt_up(); }
const float &dphi_jj_up() { return mytree.dphi_jj_up(); }
const float &dphi_ll_up() { return mytree.dphi_ll_up(); }
const float &sum_mlb_up() { return mytree.sum_mlb_up(); }
const float &deta_jj_up() { return mytree.deta_jj_up(); }
const float &dR_jj_up() { return mytree.dR_jj_up(); }
const float &dphi_metj1_up() { return mytree.dphi_metj1_up(); }
const float &dphi_metj2_up() { return mytree.dphi_metj2_up(); }
const float &mjj_mindphi_dn() { return mytree.mjj_mindphi_dn(); }
const float &mjj_dn() { return mytree.mjj_dn(); }
const float &mbb_csv_dn() { return mytree.mbb_csv_dn(); }
const float &mbb_bpt_dn() { return mytree.mbb_bpt_dn(); }
const float &dphi_jj_dn() { return mytree.dphi_jj_dn(); }
const float &dphi_ll_dn() { return mytree.dphi_ll_dn(); }
const float &sum_mlb_dn() { return mytree.sum_mlb_dn(); }
const float &deta_jj_dn() { return mytree.deta_jj_dn(); }
const float &dR_jj_dn() { return mytree.dR_jj_dn(); }
const float &dphi_metj1_dn() { return mytree.dphi_metj1_dn(); }
const float &dphi_metj2_dn() { return mytree.dphi_metj2_dn(); }
const float &weight_btagsf() { return mytree.weight_btagsf(); }
const float &weight_btagsf_heavy_UP() { return mytree.weight_btagsf_heavy_UP(); }
const float &weight_btagsf_light_UP() { return mytree.weight_btagsf_light_UP(); }
const float &weight_btagsf_heavy_DN() { return mytree.weight_btagsf_heavy_DN(); }
const float &weight_btagsf_light_DN() { return mytree.weight_btagsf_light_DN(); }
const float &chpfcands_0013_pt() { return mytree.chpfcands_0013_pt(); }
const float &chpfcands_1316_pt() { return mytree.chpfcands_1316_pt(); }
const float &chpfcands_1624_pt() { return mytree.chpfcands_1624_pt(); }
const float &chpfcands_2430_pt() { return mytree.chpfcands_2430_pt(); }
const float &chpfcands_30in_pt() { return mytree.chpfcands_30in_pt(); }
const float &phpfcands_0013_pt() { return mytree.phpfcands_0013_pt(); }
const float &phpfcands_1316_pt() { return mytree.phpfcands_1316_pt(); }
const float &phpfcands_1624_pt() { return mytree.phpfcands_1624_pt(); }
const float &phpfcands_2430_pt() { return mytree.phpfcands_2430_pt(); }
const float &phpfcands_30in_pt() { return mytree.phpfcands_30in_pt(); }
const float &nupfcands_0013_pt() { return mytree.nupfcands_0013_pt(); }
const float &nupfcands_1316_pt() { return mytree.nupfcands_1316_pt(); }
const float &nupfcands_1624_pt() { return mytree.nupfcands_1624_pt(); }
const float &nupfcands_2430_pt() { return mytree.nupfcands_2430_pt(); }
const float &nupfcands_30in_pt() { return mytree.nupfcands_30in_pt(); }
const float &chpfcands_0013_sumet() { return mytree.chpfcands_0013_sumet(); }
const float &chpfcands_1316_sumet() { return mytree.chpfcands_1316_sumet(); }
const float &chpfcands_1624_sumet() { return mytree.chpfcands_1624_sumet(); }
const float &chpfcands_2430_sumet() { return mytree.chpfcands_2430_sumet(); }
const float &chpfcands_30in_sumet() { return mytree.chpfcands_30in_sumet(); }
const float &phpfcands_0013_sumet() { return mytree.phpfcands_0013_sumet(); }
const float &phpfcands_1316_sumet() { return mytree.phpfcands_1316_sumet(); }
const float &phpfcands_1624_sumet() { return mytree.phpfcands_1624_sumet(); }
const float &phpfcands_2430_sumet() { return mytree.phpfcands_2430_sumet(); }
const float &phpfcands_30in_sumet() { return mytree.phpfcands_30in_sumet(); }
const float &nupfcands_0013_sumet() { return mytree.nupfcands_0013_sumet(); }
const float &nupfcands_1316_sumet() { return mytree.nupfcands_1316_sumet(); }
const float &nupfcands_1624_sumet() { return mytree.nupfcands_1624_sumet(); }
const float &nupfcands_2430_sumet() { return mytree.nupfcands_2430_sumet(); }
const float &nupfcands_30in_sumet() { return mytree.nupfcands_30in_sumet(); }
const float &chpfcands_0013_phi() { return mytree.chpfcands_0013_phi(); }
const float &chpfcands_1316_phi() { return mytree.chpfcands_1316_phi(); }
const float &chpfcands_1624_phi() { return mytree.chpfcands_1624_phi(); }
const float &chpfcands_2430_phi() { return mytree.chpfcands_2430_phi(); }
const float &chpfcands_30in_phi() { return mytree.chpfcands_30in_phi(); }
const float &phpfcands_0013_phi() { return mytree.phpfcands_0013_phi(); }
const float &phpfcands_1316_phi() { return mytree.phpfcands_1316_phi(); }
const float &phpfcands_1624_phi() { return mytree.phpfcands_1624_phi(); }
const float &phpfcands_2430_phi() { return mytree.phpfcands_2430_phi(); }
const float &phpfcands_30in_phi() { return mytree.phpfcands_30in_phi(); }
const float &nupfcands_0013_phi() { return mytree.nupfcands_0013_phi(); }
const float &nupfcands_1316_phi() { return mytree.nupfcands_1316_phi(); }
const float &nupfcands_1624_phi() { return mytree.nupfcands_1624_phi(); }
const float &nupfcands_2430_phi() { return mytree.nupfcands_2430_phi(); }
const float &nupfcands_30in_phi() { return mytree.nupfcands_30in_phi(); }
const float &met_T1CHS_pt() { return mytree.met_T1CHS_pt(); }
const float &met_T1CHS_phi() { return mytree.met_T1CHS_phi(); }
const float &met_T1CHS_fromCORE_pt() { return mytree.met_T1CHS_fromCORE_pt(); }
const float &met_T1CHS_fromCORE_phi() { return mytree.met_T1CHS_fromCORE_phi(); }
const float &met_T1CHS_miniAOD_CORE_pt() { return mytree.met_T1CHS_miniAOD_CORE_pt(); }
const float &met_T1CHS_miniAOD_CORE_phi() { return mytree.met_T1CHS_miniAOD_CORE_phi(); }
const float &met_T1CHS_miniAOD_CORE_up_pt() { return mytree.met_T1CHS_miniAOD_CORE_up_pt(); }
const float &met_T1CHS_miniAOD_CORE_up_phi() { return mytree.met_T1CHS_miniAOD_CORE_up_phi(); }
const float &met_T1CHS_miniAOD_CORE_dn_pt() { return mytree.met_T1CHS_miniAOD_CORE_dn_pt(); }
const float &met_T1CHS_miniAOD_CORE_dn_phi() { return mytree.met_T1CHS_miniAOD_CORE_dn_phi(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &decayedphoton_lep1_p4() { return mytree.decayedphoton_lep1_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &decayedphoton_lep2_p4() { return mytree.decayedphoton_lep2_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &decayedphoton_bosn_p4() { return mytree.decayedphoton_bosn_p4(); }
const float &decayedphoton_mt2() { return mytree.decayedphoton_mt2(); }
const int &hyp_type() { return mytree.hyp_type(); }
const int &evt_type() { return mytree.evt_type(); }
const int &mass_gluino() { return mytree.mass_gluino(); }
const int &mass_LSP() { return mytree.mass_LSP(); }
const int &mass_chi() { return mytree.mass_chi(); }
const float &isrboost() { return mytree.isrboost(); }
const int &isr_njets() { return mytree.isr_njets(); }
const float &isr_weight() { return mytree.isr_weight(); }
const float &isr_unc() { return mytree.isr_unc(); }
const vector<float> &weightsf_lepid() { return mytree.weightsf_lepid(); }
const vector<float> &weightsf_lepiso() { return mytree.weightsf_lepiso(); }
const vector<float> &weightsf_lepip() { return mytree.weightsf_lepip(); }
const vector<float> &weightsf_lepreco() { return mytree.weightsf_lepreco(); }
const vector<float> &weightsf_lepconv() { return mytree.weightsf_lepconv(); }
const vector<float> &weightsf_lepid_FS() { return mytree.weightsf_lepid_FS(); }
const vector<float> &weightsf_lepiso_FS() { return mytree.weightsf_lepiso_FS(); }
const vector<float> &weightsf_lepip_FS() { return mytree.weightsf_lepip_FS(); }
